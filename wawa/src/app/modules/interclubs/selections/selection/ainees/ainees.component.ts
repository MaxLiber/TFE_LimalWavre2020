...
@Component({
  selector: 'app-interclubs-selections-ainees',
  templateUrl: './ainees.component.html',
  styleUrls: ['./ainees.component.scss']
})
export class AineesComponent implements OnInit 
{
