import { NgZone, OnDestroy, OnChanges, SimpleChanges } from '@angular/core';
import { DomSanitizer, SafeResourceUrl } from '@angular/platform-browser';
import { EventEmitter } from '@angular/core';
export declare type viewerType = 'google' | 'office' | 'mammoth' | 'pdf';
export declare class NgxDocViewerComponent implements OnChanges, OnDestroy {
    ...
    checkIFrame(iframe: HTMLIFrameElement): void;
