...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r463); const ctx_r462 = ɵngcc0.ɵɵnextContext(); return ctx_r462.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r463); const ctx_r464 = ɵngcc0.ɵɵnextContext(); return ctx_r464.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r460.message.severity == "info", ctx_r460.message.severity == "warn", ctx_r460.message.severity == "error", ctx_r460.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r460.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r460.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r470); const ctx_r469 = ɵngcc0.ɵɵnextContext(); return ctx_r469.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r470); const ctx_r471 = ɵngcc0.ɵɵnextContext(); return ctx_r471.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r467 = ctx.$implicit;
    const i_r468 = ctx.index;
    const ctx_r466 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r467)("index", i_r468)("template", ctx_r466.template)("@toastAnimation", undefined)("showTransitionOptions", ctx_r466.showTransitionOptions)("hideTransitionOptions", ctx_r466.hideTransitionOptions);
} }
