...
function PasswordStrengthMeterComponent_ng_container_3_small_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r180.feedback.warning, " ");
} }
function PasswordStrengthMeterComponent_ng_container_3_small_2_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const suggetion_r183 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(suggetion_r183);
} }
function PasswordStrengthMeterComponent_ng_container_3_small_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r181.feedback.suggestions);
} }
function PasswordStrengthMeterComponent_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r179.feedback.warning);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r179.feedback.suggestions && ctx_r179.feedback.suggestions.length > 0);
} }
...
PasswordStrengthMeterComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PasswordStrengthMeterComponent, selectors: [["password-strength-meter"]], inputs: { minPasswordLength: "minPasswordLength", enableFeedback: "enableFeedback", colors: "colors", password: "password" }, outputs: { strengthChange: "strengthChange" }, features: [ɵngcc0.ɵɵProvidersFeature([PasswordStrengthMeterService]), ɵngcc0.ɵɵNgOnChangesFeature()], decls: 4, vars: 4, consts: [[1, "strength-meter"], [1, "strength-meter-fill"], [4, "ngIf"], ["class", "password-feedback", 4, "ngIf"], ["class", "password-suggetion", 4, "ngIf"], [1, "password-feedback"], [1, "password-suggetion"], [4, "ngFor", "ngForOf"]], template: function PasswordStrengthMeterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵstyleProp("background", ctx.getMeterFillColor(ctx.passwordStrength), ɵngcc0.ɵɵdefaultStyleSanitizer);
        ɵngcc0.ɵɵattribute("data-strength", ctx.passwordStrength);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx.enableFeedback && ctx.feedback);
    } }, directives: [ɵngcc1.NgIf, ɵngcc1.NgForOf], styles: [".strength-meter[_ngcontent-%COMP%]{position:relative;height:3px;background:#ddd;margin:10px auto;border-radius:3px}.strength-meter[_ngcontent-%COMP%]:after, .strength-meter[_ngcontent-%COMP%]:before{content:\"\";height:inherit;background:0 0;display:block;border-color:#fff;border-style:solid;border-width:0 5px;position:absolute;width:calc(((100% - 20px)/ 5) + 10px);z-index:10}.strength-meter[_ngcontent-%COMP%]:before{left:calc((100% - 20px)/ 5)}.strength-meter[_ngcontent-%COMP%]:after{right:calc((100% - 20px)/ 5)}.strength-meter-fill[_ngcontent-%COMP%]{background:0 0;height:inherit;position:absolute;width:0;border-radius:inherit;transition:width .5s ease-in-out,background .25s}.strength-meter-fill[data-strength=\"0\"][_ngcontent-%COMP%]{background:#8b0000;width:20%}.strength-meter-fill[data-strength=\"1\"][_ngcontent-%COMP%]{background:#ff4500;width:40%}.strength-meter-fill[data-strength=\"2\"][_ngcontent-%COMP%]{background:orange;width:60%}.strength-meter-fill[data-strength=\"3\"][_ngcontent-%COMP%]{background:#9acd32;width:80%}.strength-meter-fill[data-strength=\"4\"][_ngcontent-%COMP%]{background:green;width:100%}.password-feedback[_ngcontent-%COMP%], .password-suggetion[_ngcontent-%COMP%]{font-size:70%;font-weight:400;color:#6c757d!important;display:inline-block;margin-top:.25rem}"] });
/** @nocollapse */
