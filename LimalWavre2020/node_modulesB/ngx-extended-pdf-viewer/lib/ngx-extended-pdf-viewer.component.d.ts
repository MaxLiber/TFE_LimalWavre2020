import { OnChanges, SimpleChanges, OnDestroy, EventEmitter, NgZone, TemplateRef } from '@angular/core';
...
export declare class NgxExtendedPdfViewerComponent implements AfterViewInit, OnChanges, OnDestroy {
    private ngZone;
    private platformId;
    ...
    */
    ...
    constructor(ngZone: NgZone, platformId: any);
    private loadViewer;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NgxExtendedPdfViewerComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgxExtendedPdfViewerComponent, "ngx-extended-pdf-viewer", never, {
    ...
    "showSidebarOnLoad": "showSidebarOnLoad";
