(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash.deburr'), require('@angular/common'), require('@angular/forms'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngx-extended-pdf-viewer', ['exports', 'lodash.deburr', '@angular/common', '@angular/forms', '@angular/core'], factory) :
    (factory((global['ngx-extended-pdf-viewer'] = {}),global.deburr,global.ng.common,global.ng.forms,global.ng.core));
}(this, (function (exports,deburr,common,forms,i0) { 'use strict';
    ...
    var NgxExtendedPdfViewerComponent = /** @class */ (function () {
        ...
        NgxExtendedPdfViewerComponent.propDecorators = {
            ...
            ignoreResponsiveCSS: [{ type: i0.Input }],
